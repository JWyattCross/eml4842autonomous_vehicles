...
static const _CurrentGoalPose_type_support_symbol_names_t _CurrentGoalPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gps_nav_interfaces, msg, CurrentGoalPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gps_nav_interfaces, msg, CurrentGoalPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gps_nav_interfaces, msg, CurrentGoalPose)() {
  return &::gps_nav_interfaces::msg::rosidl_typesupport_c::CurrentGoalPose_message_type_support_handle;
}
